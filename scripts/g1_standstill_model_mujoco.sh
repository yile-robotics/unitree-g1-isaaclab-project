...
MODEL_ITERATION="${1:-34000}"
CHECKPOINT="${RUN_DIR}/model_${MODEL_ITERATION}.pt"
DEPLOY_SRC="${RUN_DIR}/params/deploy.yaml"

MUJOCO_POLICY_DIR="${UNITREE_RL_LAB}/deploy/robots/g1_29dof/config/policy/velocity/model_${MODEL_ITERATION}_standstill_mujoco"
...
echo "Prepared model_${MODEL_ITERATION} standstill policy for MuJoCo:"

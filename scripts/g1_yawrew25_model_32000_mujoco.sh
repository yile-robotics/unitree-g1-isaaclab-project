...
MUJOCO_POLICY_DIR="${UNITREE_RL_LAB}/deploy/robots/g1_29dof/config/policy/velocity/model_32000_yawrew25_mujoco"
...
echo "Prepared model_32000 yawrew25 policy for MuJoCo:"

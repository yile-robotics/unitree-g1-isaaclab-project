...
RUN_DIR="${UNITREE_RL_LAB}/logs/rsl_rl/unitree_g1_29dof_agile_reward_velocity_antishuffle/2026-06-14_23-47-45_feet_air_time03_clearance10"
MODEL_ITERATION="${1:-25500}"
CHECKPOINT="${RUN_DIR}/model_${MODEL_ITERATION}.pt"
DEPLOY_SRC="${RUN_DIR}/params/deploy.yaml"

MUJOCO_POLICY_DIR="${UNITREE_RL_LAB}/deploy/robots/g1_29dof/config/policy/velocity/model_${MODEL_ITERATION}_clearance10_mujoco"
...
echo "Prepared model_${MODEL_ITERATION} anti-shuffle policy for MuJoCo."
echo
echo "Terminal 1:"
echo "  cd ${SIM_DIR}"
echo "  ${SIM_BIN}"

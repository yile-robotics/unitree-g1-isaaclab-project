...
RUN_DIR="${UNITREE_RL_LAB}/logs/rsl_rl/unitree_g1_29dof_velocity/2026-06-03_14-47-42_g1_29dof_stand002_xm03_x06_y05_yaw04_seed42"
POLICY_SRC="${RUN_DIR}/exported/policy.onnx"
DEPLOY_SRC="${RUN_DIR}/params/deploy.yaml"

MUJOCO_POLICY_DIR="${UNITREE_RL_LAB}/deploy/robots/g1_29dof/config/policy/velocity/model_20000_mujoco"

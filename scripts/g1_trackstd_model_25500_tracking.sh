...
MODEL_NAME="model_25500"
RUN_DIR="/home/yile/projects/unitree_rl_lab/logs/rsl_rl/unitree_g1_29dof_velocity/2026-06-04_12-39-20_g1_29dof_trackstd_lin02_yaw015_yawrew2_seed42"
...
# Command range from the current G1 29dof velocity config:
#   vx: [-0.3, 0.6] m/s
#   vy: [-0.5, 0.5] m/s
#   wz: [-0.4, 0.4] rad/s
...
run_case "forward_060"     0.60   0.00   0.00
...
run_case "left_050"        0.00   0.50   0.00
run_case "right_010"       0.00  -0.10   0.00
run_case "right_030"       0.00  -0.30   0.00
run_case "right_050"       0.00  -0.50   0.00

run_case "yaw_left_010"    0.00   0.00   0.10
run_case "yaw_left_020"    0.00   0.00   0.20
run_case "yaw_left_040"    0.00   0.00   0.40
run_case "yaw_right_010"   0.00   0.00  -0.10
run_case "yaw_right_020"   0.00   0.00  -0.20
run_case "yaw_right_040"   0.00   0.00  -0.40

run_case "diag_small"      0.10   0.10   0.10
run_case "diag_medium"     0.30   0.25   0.20
run_case "diag_limit_pos"  0.60   0.50   0.40
run_case "diag_limit_neg" -0.30  -0.50  -0.40
run_case "cross_turn"      0.30  -0.25   0.20

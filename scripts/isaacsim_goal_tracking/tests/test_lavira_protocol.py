...
class NavigationDecisionProtocolTest(unittest.TestCase):
    def test_default_endpoint_timeout_and_legacy_cli_alias(self) -> None:
        ...
        self.assertEqual(defaults.nav_map_mode, "lavira_compatible_global")
        self.assertEqual(defaults.nav_global_origin_mode, "spawn_center")
        self.assertEqual(defaults.nav_global_downscaling, 2)
        self.assertEqual(defaults.nav_global_center_reset_steps, 25)
        self.assertEqual(defaults.nav_global_unknown_space_policy, "blocked")

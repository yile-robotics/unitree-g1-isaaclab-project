...
OUT_DIR="/home/yile/projects/unitree_rl_lab/logs/rsl_rl/unitree_g1_29dof_velocity/2026-05-27_18-37-19_official_retry_seed43/tracking_eval/model_12000"
RAW_DIR="${OUT_DIR}/raw"
...
fig.suptitle("model_12000 velocity tracking: command vs actual", fontsize=15, fontweight="bold")
...
ax.set_title("model_12000 tracking error", fontsize=15, fontweight="bold")
...
table.scale(1, 1.35)
ax.set_title("model_12000 tracking summary", fontsize=15, fontweight="bold")

...
RUN_DIR="${UNITREE_RL_LAB}/logs/rsl_rl/unitree_g1_29dof_velocity/2026-06-09_11-14-36_g1_29dof_standstill_finetune3k_seed42"
CHECKPOINT="${RUN_DIR}/model_33500.pt"
DEPLOY_SRC="${RUN_DIR}/params/deploy.yaml"

MUJOCO_POLICY_DIR="${UNITREE_RL_LAB}/deploy/robots/g1_29dof/config/policy/velocity/model_33500_standstill_mujoco"
POLICY_DST="${MUJOCO_POLICY_DIR}/exported/policy.onnx"
DEPLOY_DST="${MUJOCO_POLICY_DIR}/params/deploy.yaml"
EVAL_DIR="${RUN_DIR}/mujoco_tracking_eval_model_33500_dense005"
CSV_PATH="${EVAL_DIR}/raw.csv"
CMD_PATH="/tmp/g1_mujoco_tracking_cmd_model_33500.txt"
...
echo "Prepared model_33500 automatic MuJoCo tracking evaluation."
...
echo "  ${PYTHON} scripts/plot_mujoco_tracking_summary.py \\"
echo "    --csv ${CSV_PATH} \\"

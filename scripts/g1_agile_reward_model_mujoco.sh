...
RUN_DIR="${UNITREE_RL_LAB}/logs/rsl_rl/unitree_g1_29dof_agile_reward_velocity/2026-06-14_11-01-04_agile_reward_velocity"
MODEL_ITERATION="${1:-23500}"
CHECKPOINT="${RUN_DIR}/model_${MODEL_ITERATION}.pt"
DEPLOY_SRC="${RUN_DIR}/params/deploy.yaml"

MUJOCO_POLICY_DIR="${UNITREE_RL_LAB}/deploy/robots/g1_29dof/config/policy/velocity/model_${MODEL_ITERATION}_agile_reward_mujoco"
...
# The MuJoCo controller supplies commands from its keyboard observation.
...
echo "Prepared model_${MODEL_ITERATION} for MuJoCo:"
